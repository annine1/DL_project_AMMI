...
parser.add_argument('-n', '--num_epochs', help='This is the name of epochs', type=int, required=True)
...
# python3 main.py --model_name resnet --num_epochs 10
# pip freeze > requirements.txt

#push on github:
# git init
# git remote add origin git@github.com:annine1/DL_project_AMMI.git
# git add .
